...
Simulink.BlockDiagram.createSubSystem([getSimulinkBlockHandle([name '/T(z)']), getSimulinkBlockHandle([name '/Sum1']),  getSimulinkBlockHandle([name '/1//S(z)']), getSimulinkBlockHandle([name '/R(z)'])]);
%c code generation
